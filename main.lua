...
local GUI_NAME = "NOVA_Script_Rel_V2.8_Info"
...
local function BuildInterface(isReload)
    ...
    themeNote.Size = UDim2.new(0.96, 0, 0, 20) -- কিছুটা বড় সাইজ দেওয়া হয়েছে যাতে টেক্সট কেটে না যায়
